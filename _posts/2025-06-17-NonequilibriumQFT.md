...
tags: [Machine Learning, Computational Finance, Stochastic Calculus, Fractional Calculus, Scientific Computation, Quantum Computation, Stochastic Quantization]
math:       true        # enable KaTeX
---
# Notes on Nonequilibrium Quantum Field Theory  (Draft)

## Abstract
Sources in nonequilibrium quantum field theory are provided following foundational materials in equilibrium statistical mechanics. The philosophy of euclidean field theory is assumed: Flucutations of either quantum or statistical physical orgin are viewed as mathematically equivalent. Physical applications include fields at finite temperature; including Bose-Einstein condensation, relativistic heavy ion collisions, and cosmology of the early universe.  
