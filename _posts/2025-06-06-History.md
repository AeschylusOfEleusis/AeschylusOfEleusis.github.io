...
tags: [Stochastic Quantization,Quantum Field Theory,  Triviality, NonequilibriumQFT, PathIntegrals, Foundations QM]
math:       true        # enable KaTeX
---
# Notes on Quantum Field Theory: History & Overview (Draft)

## Abstract
The history of quantum field theory is considered here using primary sources, historical texts, and formal historical analyses (including scientific biographies and first hand accounts). The development of quantum field theory, with roots in quantum electrodynamics, diverges (and subsequently reconverges) with respect to many-body theory, gauge theory, and renormalization; as evidenced by field theoretic approaches in disciplines such as high energy and condensed matter physics. Selection of materials provided here echo this divergence and reconvergence over time. Outside of a particular historical role of any particular source considered, the primary criteria for selection of sources is exposure of the power and breadth of quantum field theory.   
...
| S20 | [Wilson “Renormalizaiton Group and Critical I” 1971](https://journals.aps.org/prb/abstract/10.1103/PhysRevB.4.3174) | Introduces the renormalization group framework for understanding critical phenomena in statistical systems. |
| S21 | [Wilson “Renormalizaiton Group and Critical II” 1971](https://journals.aps.org/prb/abstract/10.1103/PhysRevB.4.3184) | Develops momentum-shell renormalization techniques and applies them to phase transitions in condensed matter. |
