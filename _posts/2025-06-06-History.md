...
## Abstract
A technical history of quantum field theory is considered using: 1.  Primary sources, 2. Historical pedagogical text books, and 3. Formal histories (including scientific biographies and first hand accounts). With roots in quantum electrodynamics, the history of quantum field theory diverges (then reconverges) with respect to gauge theory, many-body theory, and renormalization; as evidenced by these topic's role in high energy and condensed matter physics. Consequently, there is often considerable overlap between these disciplines. Materials provided here echo this divergence and reconvergence over time. Outside of a particular historical role, the primary criteria for selection of sources is illustration of the precision and breadth of quantum field theory.   
