...
The subject of rotating traversable wormholes in general relativity sits at an intersection of exact-solution theory, numerical relativity, spinor field theory, and gravitational-wave phenomenology---making it a natural to consider for projects in scientific computing. The treatment here is bibliographic; with aim to provide a structured reading path through the three decades of literature: From Ellis's 1973 drainhole through recent numerical relativity studies of dynamical stability. The 46 primary references catalogued are organized by five thematic blocks, each building on the preceding material and each connected to concrete computational projects.
