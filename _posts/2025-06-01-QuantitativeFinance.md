...
| ID | Source | Notes |
|---|---|---|
| **S20** | [Di Francesco *et al.*, *Random Matrices* (1994)](https://arxiv.org/abs/hep-th/9306153) | Random-matrix theory. |
...
| **S24** | [Yakovenko, *Stat-Mech Econophysics* (2008)](https://arxiv.org/abs/0709.3662) | Review of the literature and methods. |
| **S25** | [Chakraborti et al, *Econophysics: Kinetic-Exchange Models* (2010)](https://arxiv.org/abs/0909.1974) | Review of the literatute and methods. |
| **S26** | [Chakrabarti *et al.*, *Econophysics* (2012)](https://www.jstor.org/stable/23251800) | Review of the literature and methods. |
| **S27** | [Chakraborti *et al.*, *Econophysicss* (2013)](https://link.springer.com/chapter/10.1007/978-3-319-08473-2_11) | Review of the literature and methods. |
| **S28** | [Sornette, *Econophysics: A Review* (2014)](https://arxiv.org/abs/1404.0243) | Review of the literature and methods. |
...
| **S34** | [Potters & Bouchaud, *A First Course in Random-Matrix Theory* (2020)](https://www.cambridge.org/core/books/first-course-in-random-matrix-theory/2292A554A9BB9E2A4697C35BCE920304) | Foundations of RMT with applications to covariance. |
