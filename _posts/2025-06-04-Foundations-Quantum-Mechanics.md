...
tags: [Quantum Field Theory, Path Integrals, FoundationsQuantumMechanics]
...
Original primary sources concerning the foundations of Quantum Mechanics are provided. Relevant texts concerning the associated historical circumstances are interspersed with the technical literature. The sources are roughly grouped according the school of thought of the various interpretations. This collection of primary sources is at best an idiocratic sampling of the literature; far from exhaustive with respect to either the number or interpretations or the literature of a particular interpretation. 
...
| S6  | [Schrödinger “Jumps II” 1952](http://www.ub.edu/hcub/hfq/sites/default/files/Quantum_Jumps_II_0.pdf)                   | Continues the examination of quantum discontinuities, exploring how wave mechanics can accommodate “jumps.”          |
...
| S10 | [Joas and Lehner “Optical Mechanical Analogy” 2009](https://philpapers.org/rec/JOATCR-3)                                | Explores the analogy between geometric optics and classical mechanics as a precursor to wave‐mechanical insights.    |
...
| S21  | [Pais “Niels Bohr’s Times”](https://academic.oup.com/book/53371)                                                                  | Provides a detailed historical account of Bohr’s development of the Copenhagen interpretation and related debates.   |
